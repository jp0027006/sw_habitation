import { NewblogProps } from "@/types/blog";
...
export default function NewBlog({ blogitems }: NewblogProps) {
  ...
  return (
    <>
      ...
      <Link href="/blogs" target="_self" className="w-full flex justify-center mt-[60px] md:mt-[70px] lg:mt-[72px]">
